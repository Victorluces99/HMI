 ...
 */
package com.prueba.hmisubprojectestructuras.nodes;
 ...
 * @author Víctor Luces
 */
@NodeFactory.Registration(projectType = "com-prueba-hmiproject", position = 30)
public class HMISubprojectEstructurasNodeFactory implements NodeFactory {
    ...
    public NodeList<?> createNodes(Project project) {
        ...
        for (Project panelProject : getAllSubProject(project.getProjectDirectory())) {
