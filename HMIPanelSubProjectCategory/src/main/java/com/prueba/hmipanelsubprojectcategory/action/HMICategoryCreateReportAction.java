 ...
 * @author Victor
 */
public class HMICategoryCreateReportAction extends AbstractAction implements ContextAwareAction{
    private final static String FILE_NAME_DISPLAY_EXT = "rpt";
 //   private final static String DISPLAY_TEMPLATE_PATH = 
    private Project project;

    public HMICategoryCreateReportAction(Project project) {
        super("Crear Informe");
