 ...
 * @author Victor
 */
public class HMICategoryCreateScriptsAction extends AbstractAction implements ContextAwareAction {
    private final static String FILE_NAME_DISPLAY_EXT = "scp";
 //   private final static String DISPLAY_TEMPLATE_PATH = 
    private Project project;

    public HMICategoryCreateScriptsAction(Project project) {
        super("Crear Script");
