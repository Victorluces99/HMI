 ...
 * @author Victor
 */
public class HMICategoryCreateWarningManagementAction extends AbstractAction implements ContextAwareAction {
    private final static String FILE_NAME_DISPLAY_EXT = "wmg";
 //   private final static String DISPLAY_TEMPLATE_PATH = 
    private Project project;

    public HMICategoryCreateWarningManagementAction(Project project) {
        super("Crear Aviso");
